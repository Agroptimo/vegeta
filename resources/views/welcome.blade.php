...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="relative bg-white overflow-hidden">
                  ...
                  <div class="sm:text-center lg:text-left">
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                      <div class="rounded-md shadow">
                        <a href="#" class="w-full flex items-center justify-center px-1s border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                          Cotiza
                        </a>
                      </div>
          ...
          <div class="full-w mx-auto bg-indigo-600 px-2 lg:px-4 ">
                <div class="max-w-screen-xl mx-auto py-10">
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2">
                            <div class="m-2 p-2 bg-white border border-transparent rounded-md p-6">
                                <h3 class=" text-2xl py-4">Beneficios</h3>
                                <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"> 
                                    ...
                                    mecanismos se basan en una serie de compuestos entre los cuales encontramos las <span class="color-green">SAPONINAS</span>.<br>
                                    {{-- <span class="color-green">GROACTIVE®</span> es un bioestimulante formulado a base de extractos de plantas ricos en saponinas y
